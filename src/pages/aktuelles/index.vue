                    ...
                    <div class="card">
                        <div class="card-image">
                            <figure class="image is-4by3">
                                <img
                                    :src="post.content.image | transformImage('400x300/smart')"
                        ...
                        <div class="card-content">
                            <div class="media">
                                <div v-if="post.author" class="media-left">
                                    <figure class="image is-1-by-1">
                                        <img
                                            :src="post.author.avatar | transformImage('72x72/smart')"
                                ...
                                <div class="media-content">
                                    ...
                                    <div class="subtitle is-6">
                                        <span v-if="post.author && post.author.name">von {{ post.author.name }}</span>
                                        am <time>{{ post.content.datum || post.created_at | formatDate }}</time>
                                    </div>
                                </div>
                            </div>
                            ...
                            <nuxt-link v-if="isempty(post.content.content)" :to="'/aktuelles/' + post.slug"
                                >Lesen</nuxt-link
                            >
                        </div>
                    </div>
...
export default {
    ...
    async asyncData(context) {
        ...
        const index = await context.app.$storyapi.get('cdn/stories/posts/index', {
        ...
        const articles = stories.data.stories.filter((s) => s.content.component == 'post')
        articles.forEach((a) => {
